 ...
 * M3b9：非省会 prefecture_city ≥8 的省各 ≥8 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南与非省会总数 <8 的省）。本刀是 M3b 第八批，不是 293 / 333 完成。
 * M3b10：非省会 prefecture_city ≥9 的省各 ≥9 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建与非省会总数 <9 的省）。本刀是 M3b 第九批，不是 293 / 333 完成。
 * M3b11：非省会 prefecture_city ≥10 的省各 ≥10 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建、陕西与非省会总数 <10 的省）。本刀是 M3b 第十批，不是 293 / 333 完成。
 * M3b12：非省会 prefecture_city ≥11 的省各 ≥11 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建、陕西、河北、山西、浙江、江西、黑龙江与非省会总数 <11 的省）。本刀是 M3b 第十一批，不是 293 / 333 完成。
...
export const M3A_PIPELINE = [
  ...
  { adcode: '131000', packId: 'langfang', region7: '华北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '140300', packId: 'yangquan', region7: '华北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '150300', packId: 'wuhai', region7: '华北', status: 'live', kit: 'oasis-flat' },
  { adcode: '211300', packId: 'chaoyang', region7: '东北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '230400', packId: 'hegang', region7: '东北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '320900', packId: 'yancheng', region7: '华东', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '330500', packId: 'huzhou', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '341600', packId: 'bozhou', region7: '华东', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '350400', packId: 'sanming', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '360300', packId: 'pingxiang', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '370300', packId: 'zibo', region7: '华东', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '410700', packId: 'xinxiang', region7: '华中', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '421300', packId: 'suizhou', region7: '华中', status: 'live', kit: 'jiangnan-water' },
  { adcode: '431100', packId: 'yongzhou', region7: '华中', status: 'live', kit: 'jiangnan-water' },
  { adcode: '441400', packId: 'meizhou', region7: '华南', status: 'live', kit: 'lingnan-qilou' },
  { adcode: '450900', packId: 'yulingx', region7: '华南', status: 'live', kit: 'jiangnan-water' },
  { adcode: '510300', packId: 'zigong', region7: '西南', status: 'live', kit: 'jiangnan-water' },
  { adcode: '611000', packId: 'shangluo', region7: '西北', status: 'live', kit: 'jiangnan-water' },
  { adcode: '620800', packId: 'pingliang', region7: '西北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '130500', packId: 'xingtai', region7: '华北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '140500', packId: 'jincheng', region7: '华北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '210900', packId: 'fuxin', region7: '东北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '230500', packId: 'shuangyashan', region7: '东北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '321300', packId: 'suqian', region7: '华东', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '330800', packId: 'quzhou', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '341800', packId: 'xuancheng', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '360600', packId: 'yingtan', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '371700', packId: 'heze', region7: '华东', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '411700', packId: 'zhumadian', region7: '华中', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '420700', packId: 'ezhou', region7: '华中', status: 'live', kit: 'jiangnan-water' },
  { adcode: '431300', packId: 'loudi', region7: '华中', status: 'live', kit: 'jiangnan-water' },
  { adcode: '441600', packId: 'heyuan', region7: '华南', status: 'live', kit: 'lingnan-qilou' },
  { adcode: '451400', packId: 'chongzuo', region7: '华南', status: 'live', kit: 'jiangnan-water' },
  { adcode: '511600', packId: 'guangan', region7: '西南', status: 'live', kit: 'jiangnan-water' },
  { adcode: '610200', packId: 'tongchuan', region7: '西北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '621100', packId: 'dingxi', region7: '西北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '130800', packId: 'chengde', region7: '华北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '140900', packId: 'xinzhou', region7: '华北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '211400', packId: 'huludao', region7: '东北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '230900', packId: 'qitaihe', region7: '东北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '321200', packId: 'taizhoujs', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '331100', packId: 'lishui', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '340600', packId: 'huaibei', region7: '华东', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '360500', packId: 'xinyu', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '371100', packId: 'rizhao', region7: '华东', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '411100', packId: 'luohe', region7: '华中', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '421200', packId: 'xianning', region7: '华中', status: 'live', kit: 'jiangnan-water' },
  { adcode: '430500', packId: 'shaoyang', region7: '华中', status: 'live', kit: 'jiangnan-water' },
  { adcode: '441700', packId: 'yangjiang', region7: '华南', status: 'live', kit: 'lingnan-qilou' },
  { adcode: '451000', packId: 'baise', region7: '华南', status: 'live', kit: 'jiangnan-water' },
  { adcode: '510900', packId: 'suining', region7: '西南', status: 'live', kit: 'jiangnan-water' },
  { adcode: '620200', packId: 'jiayuguan', region7: '西北', status: 'live', kit: 'oasis-flat' },
  { adcode: '210400', packId: 'fushun', region7: '东北', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '321100', packId: 'zhenjiang', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '341700', packId: 'chizhou', region7: '华东', status: 'live', kit: 'jiangnan-water' },
  { adcode: '371600', packId: 'binzhou', region7: '华东', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '410600', packId: 'hebi', region7: '华中', status: 'live', kit: 'north-brick-hutong' },
  { adcode: '420800', packId: 'jingmen', region7: '华中', status: 'live', kit: 'jiangnan-water' },
  { adcode: '431200', packId: 'huaihua', region7: '华中', status: 'live', kit: 'jiangnan-water' },
  { adcode: '440900', packId: 'maoming', region7: '华南', status: 'live', kit: 'lingnan-qilou' },
  { adcode: '451100', packId: 'hezhou', region7: '华南', status: 'live', kit: 'jiangnan-water' },
  { adcode: '511900', packId: 'bazhong', region7: '西南', status: 'live', kit: 'jiangnan-water' },
  { adcode: '620300', packId: 'jinchang', region7: '西北', status: 'live', kit: 'oasis-flat' },
]
...
/**
 * M3b9: eighth prefecture-city expansion batch.
 * Every province/AR with ≥8 non-capital prefecture_city rows gets ≥8 live.
 * Qinghai exempt (only Haidong). Hainan exempt to ≥8: Sansha is never playable,
 * so playable non-capital prefecture_city = Sanya + Danzhou = 2.
 * Xinjiang exempt to ≥8: only 3 non-capital prefecture_city (keep ≥3).
 * Ningxia exempt to ≥8: only 4 (keep ≥4).
 * Guizhou / Tibet have 5 (keep ≥5, cannot reach 8).
 * Jilin / Yunnan have 7 and are already all live (keep ≥7, cannot reach 8).
 * Any province with <8 eligible non-cap is exempt to ≥8 but must not regress.
 * Municipalities / SARs / Taiwan teaching packs are exempt.
 * 18–22 new live this slice (honest cap 25) — not 293 complete, not 333 complete.
 * 张家界 / 大理 / 黄山 stay grey. 玉林 packId is yulingx so it does not collide with 榆林.
 */
export const M3B9_NEW_LIVE = [
  'langfang',
  'yangquan',
  'wuhai',
  'chaoyang',
...
/**
 * M3b10: ninth prefecture-city expansion batch.
 * Every province/AR with ≥9 non-capital prefecture_city rows gets ≥9 live.
 * Qinghai exempt (only Haidong). Hainan exempt to ≥9: Sansha is never playable,
 * so playable non-capital prefecture_city = Sanya + Danzhou = 2.
 * Xinjiang exempt to ≥9: only 3 non-capital prefecture_city (keep ≥3).
 * Ningxia exempt to ≥9: only 4 (keep ≥4).
 * Guizhou / Tibet have 5 (keep ≥5, cannot reach 9).
 * Jilin / Yunnan have 7 and are already all live (keep ≥7, cannot reach 9).
 * Inner Mongolia / Fujian have 8 and are already all live (keep ≥8, cannot reach 9).
 * Any province with <9 eligible non-cap is exempt to ≥9 but must not regress.
 * Municipalities / SARs / Taiwan teaching packs are exempt.
 * 15–20 new live this slice (honest cap 22) — not 293 complete, not 333 complete.
 * 张家界 / 大理 / 黄山 / 泰安 stay grey. 不拿伊春林海、不拿本溪水洞。
 */
export const M3B10_NEW_LIVE = [
  'xingtai',
  'jincheng',
  'fuxin',
  'shuangyashan',
...
/**
 * M3b11: tenth prefecture-city expansion batch.
 * Every province/AR with ≥10 non-capital prefecture_city rows gets ≥10 live.
 * Qinghai exempt (only Haidong). Hainan exempt to ≥10: Sansha is never playable,
 * so playable non-capital prefecture_city = Sanya + Danzhou = 2.
 * Xinjiang exempt to ≥10: only 3 non-capital prefecture_city (keep ≥3).
 * Ningxia exempt to ≥10: only 4 (keep ≥4).
 * Guizhou / Tibet have 5 (keep ≥5, cannot reach 10).
 * Jilin / Yunnan have 7 and are already all live (keep ≥7, cannot reach 10).
 * Inner Mongolia / Fujian have 8 and are already all live (keep ≥8, cannot reach 10).
 * Shaanxi has 9 and is already all live (keep ≥9, cannot reach 10).
 * Any province with <10 eligible non-cap is exempt to ≥10 but must not regress.
 * Municipalities / SARs / Taiwan teaching packs are exempt.
 * 16 new live this slice (honest cap 20) — not 293 complete, not 333 complete.
 * 张家界 / 大理 / 黄山 / 泰安 stay grey. 不拿伊春林海、不拿本溪水洞。
 * 泰州 packId is taizhoujs so it does not collide with 台州 taizhou.
 */
export const M3B11_NEW_LIVE = [
  'chengde',
  'xinzhou',
  'huludao',
  'qitaihe',
...
/**
 * M3b12: eleventh prefecture-city expansion batch.
 * Every province/AR with ≥11 non-capital prefecture_city rows gets ≥11 live,
 * except Heilongjiang (only remaining city is 伊春, banned mountain-show).
 * Qinghai exempt (only Haidong). Hainan exempt to ≥11: Sansha is never playable.
 * Xinjiang / Ningxia / Guizhou / Tibet / Jilin / Yunnan / Inner Mongolia /
 * Fujian / Shaanxi stay at their already-live ceilings (cannot reach 11).
 * Hebei / Shanxi / Zhejiang / Jiangxi have exactly 10 and are already all live.
 * Any province with <11 eligible non-cap is exempt to ≥11 but must not regress.
 * Municipalities / SARs / Taiwan teaching packs are exempt.
 * 11 new live this slice (honest cap 15) — not 293 complete, not 333 complete.
 * 张家界 / 大理 / 黄山 / 泰安 / 伊春 / 本溪 stay grey. 池州不拿九华山。
 */
export const M3B12_NEW_LIVE = [
  'fushun',
  'zhenjiang',
  'chizhou',
  'binzhou',
...
export const DISCLAIMER =
  '本切片不宣称全国地级已收录可玩。live 3D：训练场 + 34 省各 ≥1 座行政中心 + 凡有地级市的省各 ≥1 座非省会地级市 + 非省会 prefecture_city ≥2 的省各 ≥2 座非省会 live（豁免青海）+ 非省会 prefecture_city ≥3 的省各 ≥3 座非省会 live（豁免青海与非省会总数 <3 的省；海南三沙不可玩）+ 非省会 prefecture_city ≥4 的省各 ≥4 座非省会 live（豁免青海、海南与非省会总数 <4 的省）+ 非省会 prefecture_city ≥5 的省各 ≥5 座非省会 live（豁免青海、海南、新疆与非省会总数 <5 的省）+ 非省会 prefecture_city ≥6 的省各 ≥6 座非省会 live（豁免青海、海南、新疆、宁夏与非省会总数 <6 的省）+ 非省会 prefecture_city ≥7 的省各 ≥7 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏与非省会总数 <7 的省）+ 非省会 prefecture_city ≥8 的省各 ≥8 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南与非省会总数 <8 的省）+ 非省会 prefecture_city ≥9 的省各 ≥9 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建与非省会总数 <9 的省）+ 非省会 prefecture_city ≥10 的省各 ≥10 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建、陕西与非省会总数 <10 的省）+ 非省会 prefecture_city ≥11 的省各 ≥11 座非省会 live（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建、陕西、河北、山西、浙江、江西、黑龙江与非省会总数 <11 的省）+ 七大区各 ≥3 座非省会 live（全国非省会 live ≥21）。prefecture_city live 约 257/293（M3b12 批次管线，第十一批，不是 293 完成）。其余地级为草稿或名录灰壳。不是 333 完成，也不是 293 完成。'
