...
markLiveCity('130900', 'cangzhou', 'B')
markLiveCity('140700', 'jinzhong', 'B')
markLiveCity('150600', 'ordos', 'B')
markLiveCity('210800', 'yingkou', 'B')
markLiveCity('220500', 'tonghua', 'B')
markLiveCity('231000', 'mudanjiang', 'B')
markLiveCity('320700', 'lianyungang', 'B')
markLiveCity('331000', 'taizhou', 'B')
markLiveCity('341500', 'luan', 'B')
markLiveCity('350700', 'nanping', 'B')
markLiveCity('361100', 'shangrao', 'B')
markLiveCity('371300', 'linyi', 'B')
markLiveCity('411300', 'nanyang', 'B')
markLiveCity('420300', 'shiyan', 'B')
markLiveCity('431000', 'chenzhou', 'B')
markLiveCity('441200', 'zhaoqing', 'B')
markLiveCity('450700', 'qinzhou', 'B')
markLiveCity('510500', 'luzhou', 'B')
markLiveCity('520400', 'anshun', 'B')
markLiveCity('530500', 'baoshan', 'B')
markLiveCity('540400', 'linzhi', 'B')
markLiveCity('610800', 'yulin', 'B')
markLiveCity('621000', 'qingyang', 'B')
markLiveCity('131100', 'hengshui', 'B')
markLiveCity('140600', 'shuozhou', 'B')
markLiveCity('150900', 'ulanqab', 'B')
markLiveCity('210300', 'anshan', 'B')
markLiveCity('220400', 'liaoyuan', 'B')
markLiveCity('231200', 'suihua', 'B')
markLiveCity('320300', 'xuzhou', 'B')
markLiveCity('330900', 'zhoushan', 'B')
markLiveCity('341100', 'chuzhou', 'B')
markLiveCity('350300', 'putian', 'B')
markLiveCity('361000', 'fuzhoujx', 'B')
markLiveCity('370700', 'weifang', 'B')
markLiveCity('411400', 'shangqiu', 'B')
markLiveCity('420900', 'xiaogan', 'B')
markLiveCity('430900', 'yiyang', 'B')
markLiveCity('440400', 'zhuhai', 'B')
markLiveCity('450800', 'guigang', 'B')
markLiveCity('510600', 'deyang', 'B')
markLiveCity('530900', 'lincang', 'B')
markLiveCity('610500', 'weinan', 'B')
markLiveCity('620600', 'wuwei', 'B')
markLiveCity('130700', 'zhangjiakou', 'B')
markLiveCity('141100', 'lvliang', 'B')
markLiveCity('150700', 'hulunbuir', 'B')
markLiveCity('211200', 'tieling', 'B')
markLiveCity('220600', 'baishan', 'B')
markLiveCity('230300', 'jixi', 'B')
markLiveCity('320800', 'huaian', 'B')
markLiveCity('330700', 'jinhua', 'B')
markLiveCity('341300', 'suzhouah', 'B')
markLiveCity('350800', 'longyan', 'B')
markLiveCity('360900', 'yichun', 'B')
markLiveCity('371400', 'dezhou', 'B')
markLiveCity('411600', 'zhoukou', 'B')
markLiveCity('420200', 'huangshi', 'B')
markLiveCity('430300', 'xiangtan', 'B')
markLiveCity('440200', 'shaoguan', 'B')
markLiveCity('451300', 'laibin', 'B')
markLiveCity('510400', 'panzhihua', 'B')
markLiveCity('530700', 'lijiang', 'B')
markLiveCity('610900', 'ankang', 'B')
markLiveCity('620400', 'baiyin', 'B')
markLiveCity('131000', 'langfang', 'B')
markLiveCity('140300', 'yangquan', 'B')
markLiveCity('150300', 'wuhai', 'B')
markLiveCity('211300', 'chaoyang', 'B')
markLiveCity('230400', 'hegang', 'B')
markLiveCity('320900', 'yancheng', 'B')
markLiveCity('330500', 'huzhou', 'B')
markLiveCity('341600', 'bozhou', 'B')
markLiveCity('350400', 'sanming', 'B')
markLiveCity('360300', 'pingxiang', 'B')
markLiveCity('370300', 'zibo', 'B')
markLiveCity('410700', 'xinxiang', 'B')
markLiveCity('421300', 'suizhou', 'B')
markLiveCity('431100', 'yongzhou', 'B')
markLiveCity('441400', 'meizhou', 'B')
markLiveCity('450900', 'yulingx', 'B')
markLiveCity('510300', 'zigong', 'B')
markLiveCity('611000', 'shangluo', 'B')
markLiveCity('620800', 'pingliang', 'B')
markLiveCity('130500', 'xingtai', 'B')
markLiveCity('140500', 'jincheng', 'B')
markLiveCity('210900', 'fuxin', 'B')
markLiveCity('230500', 'shuangyashan', 'B')
markLiveCity('321300', 'suqian', 'B')
markLiveCity('330800', 'quzhou', 'B')
markLiveCity('341800', 'xuancheng', 'B')
markLiveCity('360600', 'yingtan', 'B')
markLiveCity('371700', 'heze', 'B')
markLiveCity('411700', 'zhumadian', 'B')
markLiveCity('420700', 'ezhou', 'B')
markLiveCity('431300', 'loudi', 'B')
markLiveCity('441600', 'heyuan', 'B')
markLiveCity('451400', 'chongzuo', 'B')
markLiveCity('511600', 'guangan', 'B')
markLiveCity('610200', 'tongchuan', 'B')
markLiveCity('621100', 'dingxi', 'B')
markLiveCity('130800', 'chengde', 'B')
markLiveCity('140900', 'xinzhou', 'B')
markLiveCity('211400', 'huludao', 'B')
markLiveCity('230900', 'qitaihe', 'B')
markLiveCity('321200', 'taizhoujs', 'B')
markLiveCity('331100', 'lishui', 'B')
markLiveCity('340600', 'huaibei', 'B')
markLiveCity('360500', 'xinyu', 'B')
markLiveCity('371100', 'rizhao', 'B')
markLiveCity('411100', 'luohe', 'B')
markLiveCity('421200', 'xianning', 'B')
markLiveCity('430500', 'shaoyang', 'B')
markLiveCity('441700', 'yangjiang', 'B')
