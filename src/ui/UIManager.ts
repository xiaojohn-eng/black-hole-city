...
export class UIManager {
    ...
    this.layer.innerHTML = `
      <div class="overlay title-screen" data-ui="1">
        ...
        <div class="title-block">
          ...
          <p class="version">M3b10 每省非省会×9 · 收回散落的城市记忆</p>
        </div>
        ...
        <p class="footnote">不宣称全国地级已收录 · 34 省行政中心可玩 + 有地级市的省非省会 ≥9/省（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建与非省会总数 <9 的省） / 管线 / prefecture 约 230/293 · 不是 333 完成 · 不是 293 完成</p>
      </div>`
    ...
    this.layer.innerHTML = `
      <div class="overlay lobby-screen" data-ui="1">
        <div class="lobby-head">
          ...
          <div>
            <h2>全国大厅</h2>
            <p class="hint">34 省可点 · live 可进 3D · 草稿灰壳「记忆修复中」· 34 省行政中心可玩 + 有地级市的省非省会 ≥9/省（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建与非省会总数 <9 的省） / prefecture 约 ${pc.prefectureCityLive}/293 / 管线 · 不上未审中国全图</p>
          </div>
        </div>
        <div class="region-progress">
          <p>34 省行政中心可玩 ${capitalLive}/34 · 有地级市的省非省会 ≥9/省 ${pc.covered9}/${pc.need9}（豁免青海、海南、新疆、宁夏、贵州、西藏、吉林、云南、内蒙古、福建与非省会总数 <9 的省） · prefecture_city live ${pc.prefectureCityLive}/293 · 七大区可玩 ${liveRegions}/7 · 非省会 live ${nonCapLive}（≥21） · 管线 ${pipeline} 座 · <b>不是 333 完成 · 不是 293 完成</b></p>
  ...
  private prefectureCoverage(): {
    ...
    for (const p of this.admin.provinces) {
      ...
      // 三沙永不可玩，不计入「可玩非省会 ≥3 / ≥4 / ≥5 / ≥6 / ≥7 / ≥8 / ≥9」分母。
    ...
    return { need, covered, need2, covered2, need3, covered3, need4, covered4, need5, covered5, need6, covered6, need7, covered7, need8, covered8, need9, covered9, prefectureCityLive }
  }
