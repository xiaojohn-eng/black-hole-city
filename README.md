...
> **本切片范围（M3b3 每省 ≥2 非省会地级市）：** 可玩 3D = **训练场·星湾（虚构）** + **34 省各 ≥1 座行政中心 live** + **凡有地级市的省各 ≥1 座非省会地级市 live** + **非省会 prefecture_city ≥2 的省各 ≥2 座非省会 live（豁免青海）** + 七大区各 ≥3 座非省会 live（全国 ≥21）。`prefecture_city` live **约 81/293**。大厅 34 省可点；未 live 地级灰壳「记忆修复中」，**不可进 3D**。**不宣称全国地级已收录：不是 293 完成，更不是 333 完成。** 不上未审中国全图。这是 M3b 第二批扩面，不是全量。

旧方向见：[black-hole-devour](https://github.com/xiaojohn-eng/black-hole-devour)。  
M1：`docs/M1-首都课打穿-交付说明.md`。M2：`docs/M2-省级工厂起步-交付说明.md`。M3a：`docs/M3a-七大区产能打穿-交付说明.md`。M3a2：`docs/M3a2-七大区非省会可玩-交付说明.md`。M3a3：`docs/M3a3-七大区非省会×3-交付说明.md`。M3b1：`docs/M3b1-34省行政中心-交付说明.md`。M3b2：`docs/M3b2-地级市扩面每省非省会-交付说明.md`。M3b3：`docs/M3b3-地级市扩面每省非省会×2-交付说明.md`。
...
```bash
npm install
npm run validate   # 名录 + live 真城包 + 词表 + 无经纬度 + 34 省题 + 套件 + 七大区/非省会 + 34 省行政中心 + 每省非省会 ×1 / ×2
...
**34 省大厅：** 搜索省名或简称（「京」「沪」「粤」「川」）。进度条写清「34 省行政中心可玩 + 有地级市的省非省会 ≥2/省（豁免青海） / prefecture 约 81/293 / 管线」。省内列出 live 行政中心 + 非省会；其余地级灰壳。

| 七大区 | 行政中心 live | 非省会 live（M3a3 ≥3 不回退；M3b2/M3b3 扩面） |
| --- | --- | --- |
| 华北 | 北京、天津、石家庄、太原、呼和浩特 | 保定、唐山、邯郸、大同、包头、运城、赤峰 |
| 东北 | 沈阳、长春、哈尔滨 | 大连、吉林市、齐齐哈尔、丹东、松原、大庆 |
| 华东 | 上海、南京、杭州、合肥、福州、南昌、济南、台北教学包 | 苏州、青岛、无锡、宁波、芜湖、厦门、景德镇、绍兴、蚌埠、泉州、九江、东营 |
| 华中 | 郑州、武汉、长沙 | 洛阳、开封、襄阳、株洲、荆州、岳阳 |
| 华南 | 广州、南宁、海口、香港、澳门 | 深圳、桂林、佛山、三亚、北海、儋州 |
| 西南 | 重庆、成都、贵阳、昆明、拉萨 | 遵义、乐山、绵阳、曲靖、日喀则、六盘水、玉溪、山南 |
| 西北 | 西安、兰州、西宁、银川、乌鲁木齐 | 酒泉、宝鸡、咸阳、海东、石嘴山、克拉玛依、天水、吴忠、吐鲁番 |
...
- live 包：训练场 + 34 省行政中心 + 有地级市的省非省会 ≥2/省（豁免青海；`prefecture_city` 约 81/293，见 `public/packs/manifest.json` 的 `liveCityPacks`）
